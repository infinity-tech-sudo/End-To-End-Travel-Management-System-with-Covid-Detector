...
<h1 style=" top: 8px;
        ...
        <form name="myForm"  action = "bookingpage.php" enctype="multipart/form-data" method = "POST">
        <table id = "mytable">
         <tr>
            ...
            if(! $con)
            {
                ...
                $query = "SELECT * FROM hotel_t where Hotel_place = 'Bangalore' and hotel_sub_place = 'Kormangala'";  
