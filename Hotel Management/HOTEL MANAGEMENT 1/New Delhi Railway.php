...
<h1 style=" top: 8px;
        ...
        <table id = "mytable">
         <tr>
            <th style="background-color:white;color:black;padding:20px;font-size:50px;">Hotel's Name..</th>
            <th style="background-color:white;color:black;padding:20px;font-size:50px;">Hotel's view..</th>
            <th style="background-color:white;color:black;padding:20px;font-size:50px;"> Rent per day..</th>
            <th style="background-color:white;color:black;padding:20px;font-size:50px;"> Quarantine centre..</th>
         </tr>
            ...
            if(! $con)
            {
                ...
                $query = "SELECT * FROM hotel_t where Hotel_place = 'New Delhi' and hotel_sub_place = 'New Delhi Railway Station'";  
